...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex md:flex-col w-60 bg-slate-50 border-r border-slate-200">
      ...
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
        {menus.map((item) => (
          <button
            ...
            className={cn(
              "w-full flex items-center rounded-lg px-3 py-2 text-sm transition font-medium",
              active === item.id
